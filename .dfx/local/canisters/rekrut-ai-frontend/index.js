...
import { idlFactory } from './rekrut-ai-frontend.did.js';
export { idlFactory } from './rekrut-ai-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REKRUT_AI_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./rekrut-ai-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the rekrut-ai-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./rekrut-ai-frontend.did.js")._SERVICE>}
 */
export const rekrut_ai_frontend = createActor(canisterId);
