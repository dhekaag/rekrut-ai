...
import { idlFactory } from './rekrut-ai-backend.did.js';
export { idlFactory } from './rekrut-ai-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REKRUT_AI_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./rekrut-ai-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the rekrut-ai-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./rekrut-ai-backend.did.js")._SERVICE>}
 */
export const rekrut_ai_backend = createActor(canisterId);
